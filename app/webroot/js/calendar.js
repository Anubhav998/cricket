 ...
 * This is free software, and is released under the terms of the GPL
...
function _fnGetYearRow(iIndex)
{
	...
	oRowLayout.push(" title='Previous Year "+iPreviousYear+"' class='linksCalendar_'>&laquo;</a></td>");
	...
	oRowLayout.push("<a href=\"javascript:_fnShowYears('"+iIndex+"')\" title='Select Year' class='linksCalendar_' style='font-size:10px'>&nu;</a></td>");
	oRowLayout.push("<td align='center' valign='middle' width='15'>");
	oRowLayout.push("<a href=\"javascript:_fnGetSelectedYear('"+iIndex+"', '"+iNextYear+"')\"");
	oRowLayout.push(" title='Next Year "+iNextYear+"' class='linksCalendar_'>&raquo;</a></td>");
	oRowLayout.push("</tr>");
	oRowLayout.push("</table>");
...
function _fnGetMonthRow(iIndex)
{
	...
	oRowLayout.push(" title='Previous Month "+sPreviousMonth+"' class='linksCalendar_'>&laquo;</a>");
	...
	oRowLayout.push("<a href=\"javascript:_fnShowAllMonths('"+iIndex+"')\" title='Select Month' class='linksCalendar_' style='font-size:10px'>&nu;</a></td>");
	oRowLayout.push("<td align='center' valign='middle' width='15'>");
	...
	oRowLayout.push("<a href=\"javascript:_fnGetSelectedMonth('"+iIndex+"', '"+(iMonth + 1)+"')\"");
	oRowLayout.push(" title='Next Month "+sNextMonth+"' class='linksCalendar_'>&raquo;</a>");
...
function _fnGetSelectedMonth(iIndex, iMonth)
{
	...
	{
		if(iMonth > oDate.getMonth())
			oDate.setDate(oDate.getDate()+1);
		else
			oDate.setDate(oDate.getDate()-31);
	}	
	else
...
function _fnGetSelectedYearRows(iIndex, sPrevious, sNext)
{
	...
	oLayout.push(" title='Previous 15 Years' class='linksCalendar_'>&laquo;</a>");
	oLayout.push("</td>");
	...
	oLayout.push(" title='Next 15 Years' class='linksCalendar_'>&raquo;</a>");
	oLayout.push("</td>");
